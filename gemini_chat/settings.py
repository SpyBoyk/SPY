...
# # Gemini API settings
# GEMINI_API_KEY = os.getenv('GEMINI_API_KEY', 'AIzaSyDJVDY-eb0EEd1bUxMRKD4Tbv1x8pEZ-3c')

# # Session settings (important for OAuth)
...
# Database configuration: uses DATABASE_URL if available (Render), otherwise SQLite
DATABASES = {
